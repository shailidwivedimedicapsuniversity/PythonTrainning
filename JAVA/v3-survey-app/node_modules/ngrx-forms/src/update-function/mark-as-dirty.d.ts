 ...
 */
export declare function markAsDirty<TValue extends FormControlValueTypes>(state: FormControlState<TValue>): FormControlState<TValue>;
/**
 * This update function takes a form array state and marks it and all of its children as dirty.
 */
export declare function markAsDirty<TValue>(state: FormArrayState<TValue>): FormArrayState<TValue>;
/**
 * This update function takes a form group state and marks it and all of its children as dirty.
 */
export declare function markAsDirty<TValue>(state: FormGroupState<TValue>): FormGroupState<TValue>;
/**
