(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('@ngrx/store'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('survey-lib', ['exports', '@angular/common', '@angular/forms', '@ngrx/store', '@angular/core'], factory) :
    (factory((global['survey-lib'] = {}),global.ng.common,global.ng.forms,global.store,global.ng.core));
}(this, (function (exports,common,forms,store,i0) { 'use strict';
     ...
     */
    var SurveyLibService = /** @class */ (function () {
        function SurveyLibService() {
            this.enableSubmit = false;
            this.defaultThankYouPage = false;
            this.isEmbededInDesigner = false;
            this.questionAnsweredEventEmitter = new i0.EventEmitter();
            this.isQuestionCardCampaign = false;
            this.currentElementEventEmitter = new i0.EventEmitter();
         ...
         * @return {?}
         */
        SurveyLibService.prototype.initializeSurveyTheme = /**
         * @param {?} selectedThemeModel
         * @return {?}
         */
            function (selectedThemeModel) {
        ...
        /** @nocollapse */
        SurveyLibService.ctorParameters = function () { return []; };
        /** @nocollapse */ SurveyLibService.ngInjectableDef = i0.defineInjectable({ factory: function SurveyLibService_Factory() { return new SurveyLibService(); }, token: SurveyLibService, providedIn: "root" });
        return SurveyLibService;
    }());
    var CurrentElement = /** @class */ (function () {
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SurveyResponseModel = /** @class */ (function () {
        function SurveyResponseModel() {
        }
        return SurveyResponseModel;
    }());
    var SurveyResponses = /** @class */ (function () {
    ...
    var PagesService = /** @class */ (function () {
        function PagesService() {
            this.previousQuestion = new i0.EventEmitter();
            this.nextQuestion = new i0.EventEmitter();
            this.nextPageEvent = new i0.EventEmitter();
    ...
    var SurveyLibComponent = /** @class */ (function () {
        function SurveyLibComponent(surveyLibraryService, pageService) {
            ...
            this.surveyResponseEmitter = new i0.EventEmitter();
            this.isQuestionCardCampaign = false;
        ...
        /** @nocollapse */
        SurveyLibComponent.ctorParameters = function () {
            return [
        ...
        SurveyLibComponent.propDecorators = {
            surveyResponseEmitter: [{ type: i0.Output }],
            surveyContent: [{ type: i0.Input }],
            testMode: [{ type: i0.Input }],
            theme: [{ type: i0.Input }],
            currentPageIndex: [{ type: i0.Input }],
            currentQuestionIndex: [{ type: i0.Input }],
            isQuestionCardCampaign: [{ type: i0.Input }],
            responseFromQuestionCardCampaign: [{ type: i0.Input }]
        };
    ...
    var WelcomePageComponent = /** @class */ (function () {
        function WelcomePageComponent(pageService) {
            this.pageService = pageService;
         ...
         * @return {?}
         */
        WelcomePageComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        WelcomePageComponent.prototype.nextPage = /**
         * @return {?}
         */
            function () {
                var _this = this;
                 ...
                 * @return {?}
                 */function () {
                    _this.nextPageEvent.emit();
                }), 350);
            };
        /**
         * @return {?}
         */
        WelcomePageComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
            };
        ...
        WelcomePageComponent.propDecorators = {
            welcomePage: [{ type: i0.Input }],
            nextPageEvent: [{ type: i0.Output }]
        };
    ...
    ***************************************************************************** */
                ...
                switch (questionType) {
                    ...
                    case 'Yes No':
                        ...
                        try {
                            ...
                            try {
                                if (conditions_2_1 && !conditions_2_1.done && (_b = conditions_2.return))
                                    _b.call(conditions_2);
                            }
                            finally {
                                if (e_2)
                                    throw e_2.error;
                    ...
                    case 'Date':
                        ...
                        try {
                            ...
                            try {
                                if (conditions_3_1 && !conditions_3_1.done && (_c = conditions_3.return))
                                    _c.call(conditions_3);
                            }
                            finally {
                                if (e_3)
                                    throw e_3.error;
                    ...
                    case 'Short text':
                        ...
                        try {
                            ...
                            try {
                                if (conditions_4_1 && !conditions_4_1.done && (_d = conditions_4.return))
                                    _d.call(conditions_4);
                            }
                            finally {
                                if (e_4)
                                    throw e_4.error;
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var MandatoryQuestionValidation = /** @class */ (function () {
        function MandatoryQuestionValidation() {
        }
        /**
         * @param {?} questionType
         * @param {?} response
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isQuestionAnswered = /**
         * @param {?} questionType
         * @param {?} response
         * @return {?}
         */
            function (questionType, response) {
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isAddressFormAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isContactFormAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isChoiceQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isDateQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isDropDownQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isEmailQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isTextQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isRatingQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isStatementQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
         ...
         * @return {?}
         */
        MandatoryQuestionValidation.prototype.isYesNoQuestionAnswered = /**
         * @private
         * @param {?} response
         * @return {?}
         */
        ...
        return MandatoryQuestionValidation;
    }());
    ...
    var QuestionnaireComponent = /** @class */ (function () {
        function QuestionnaireComponent(pagesService, surveyLibService) {
            ...
            this.previousPageEvent = new i0.EventEmitter();
         ...
         */
            function () {
                ...
                var this_1 = this;
                try {
                    for (var _b = __values(this.questionnairePage.questions[this.surveyLibService.currentElement.currentQuestionIndex].logicJumps.blocks), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var block = _c.value;
         ...
         */
            function (questionIndexes) {
                ...
                try {
                    for (var questionIndexes_1 = __values(questionIndexes), questionIndexes_1_1 = questionIndexes_1.next(); !questionIndexes_1_1.done; questionIndexes_1_1 = questionIndexes_1.next()) {
                    ...
                    try {
                        if (questionIndexes_1_1 && !questionIndexes_1_1.done && (_a = questionIndexes_1.return))
                            _a.call(questionIndexes_1);
                    }
                    finally {
                        if (e_2)
                            throw e_2.error;
        ...
        QuestionnaireComponent.propDecorators = {
            previousPageEvent: [{ type: i0.Output }],
            currentQuestionIndex: [{ type: i0.Input }],
            submitResponse: [{ type: i0.Output }],
            questionnairePage: [{ type: i0.Input }]
        };
    ...
    var ThankYouPageComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        ThankYouPageComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        ThankYouPageComponent.ctorParameters = function () { return []; };
        ThankYouPageComponent.propDecorators = {
            thankYouPage: [{ type: i0.Input }]
        };
    ...
    var ChoiceComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        ChoiceComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
        ChoiceComponent.propDecorators = {
            choiceQuestion: [{ type: i0.Input }],
            surveyResponse: [{ type: i0.Input }],
            submitEvent: [{ type: i0.Output }],
            isLastQuestion: [{ type: i0.Input }],
            isMultipleChoice: [{ type: i0.Input }]
        };
    ...
    var YesNoComponent = /** @class */ (function () {
        function YesNoComponent(pageService) {
            this.pageService = pageService;
            this.isActive = false;
            this.submitEvent = new i0.EventEmitter();
        }
         ...
         * @return {?}
         */
        YesNoComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                if (this.pageService.stage == 'entry-next') {
         ...
         * @return {?}
         */
        YesNoComponent.prototype.onSelect = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        YesNoComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        YesNoComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
        YesNoComponent.propDecorators = {
            yesNoQuestion: [{ type: i0.Input }],
            surveyResponse: [{ type: i0.Input }],
            submitEvent: [{ type: i0.Output }]
        };
    ...
    var ShortTextComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        ShortTextComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
        ShortTextComponent.propDecorators = {
            shortText: [{ type: i0.Input }],
            surveyResponse: [{ type: i0.Input }],
            submitEvent: [{ type: i0.Output }],
            isLastQuestion: [{ type: i0.Input }]
        };
    ...
    var LongTextComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        LongTextComponent.ctorParameters = function () {
            return [
                { type: PagesService },
                { type: SurveyLibService }
            ];
    ...
    var StatementComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        StatementComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
        StatementComponent.propDecorators = {
            statement: [{ type: i0.Input }],
            surveyResponse: [{ type: i0.Input }],
            submitEvent: [{ type: i0.Output }]
        };
    ...
    var NpsComponent = /** @class */ (function () {
        function NpsComponent(pageService) {
            this.pageService = pageService;
            this.submitEvent = new i0.EventEmitter();
        }
        /**
         ...
         * @return {?}
         */
        NpsComponent.prototype.onSelect = /**
         * @param {?} rating
         * @return {?}
         */
            function (rating) {
         ...
         * @return {?}
         */
        NpsComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
                /*this.surveyState*/
    ...
    var RatingComponent = /** @class */ (function () {
        function RatingComponent(pageService) {
            this.pageService = pageService;
            this.submitEvent = new i0.EventEmitter();
            this.isActive = false;
        }
         ...
         * @return {?}
         */
        RatingComponent.prototype.ngAfterViewInit = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        RatingComponent.prototype.onRatingSelect = /**
         * @param {?} rating
         * @return {?}
         */
            function (rating) {
         ...
         * @return {?}
         */
        RatingComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
            };
    ...
    var ContactFormComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                var formGroup = {};
                try {
                    for (var _b = __values(Object.keys(this.contactForm.contactForm)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var prop = _c.value;
                        formGroup[prop] = new forms.FormControl(this.contactForm.contactForm[prop].value || '', ContactFormComponent.mapValidators(this.contactForm.contactForm[prop].validation));
                    }
                }
                catch (e_1_1) {
                    e_1 = { error: e_1_1 };
    ...
    var PhoneComponent = /** @class */ (function () {
        function PhoneComponent(pageService) {
            this.pageService = pageService;
            this.submitEvent = new i0.EventEmitter();
        }
        /**
         ...
         * @return {?}
         */
        PhoneComponent.prototype.onSubmit = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        PhoneComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        PhoneComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
    ...
    var NameComponent = /** @class */ (function () {
        function NameComponent(pageService) {
            this.pageService = pageService;
            this.submitEvent = new i0.EventEmitter();
        }
        /**
         ...
         * @return {?}
         */
        NameComponent.prototype.onSubmit = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        NameComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        NameComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
    ...
    var AgreeDisagreeComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AgreeDisagreeComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
        AgreeDisagreeComponent.propDecorators = {
            agreeDisagree: [{ type: i0.Input }],
            surveyResponse: [{ type: i0.Input }],
            submitEvent: [{ type: i0.Output }]
        };
     ...
     */
    /** @type {?} */
    var SAVE_CHOICE = 'save_choice';
    /** @type {?} */
    var SAVE_EMAIL = 'save_email';
    /** @type {?} */
    var SAVE_AGREE_DISAGREE = 'save_agree_disagree';
    /** @type {?} */
    var SAVE_PHONE = 'save_phone';
    /** @type {?} */
    var SAVE_ADDRESS = 'save_address';
    /** @type {?} */
    var SAVE_DATE = 'save_date';
    /** @type {?} */
    var SAVE_NPS = 'save_nps';
    /** @type {?} */
    var SAVE_YES_NO = 'save_yes_no';
    /** @type {?} */
    var SAVE_RATING = 'save_rating';
    /** @type {?} */
    var SAVE_LONG_TEXT = 'save_long_text';
    /** @type {?} */
    var SAVE_SHORT_TEXT = 'save_short_text';
    /** @type {?} */
    var RESET_RESPONSE = 'reset_response';
    /** @type {?} */
    var REMOVE_RESPONSES = 'remove_responses';
    /** @type {?} */
    var REMOVE_RESPONSES_OF_EXCLUDED_QUESTION_IDS = 'remove_responses_of_excluded_question_ids';
     ...
     * @return {?}
     */
    function surveyReducers(state, action) {
        if (state === void 0) {
            state = INITIAL_STATE;
        }
        console.log(state);
        switch (action.type) {
            case SAVE_CHOICE:
                return __assign({}, state, { response: getResponse(state.response, action.payload) });
            case SAVE_NPS:
                return __assign({}, state, { response: getResponse(state.response, action.payload) });
            case SAVE_YES_NO:
                return __assign({}, state, { response: getResponse(state.response, action.payload) });
            ...
            case REMOVE_RESPONSES:
                return __assign({}, state, { response: removeResponse(state.response, action.payload) });
            case REMOVE_RESPONSES_OF_EXCLUDED_QUESTION_IDS:
                return __assign({}, state, { response: removeResponsesOfExcludedQuestionIds(state.response, action.payload) });
            case RESET_RESPONSE:
    ...
    function getResponse(response, payload) {
        ...
        if (index == undefined || index < 0) {
            return __spread(response, [payload]);
        }
        else {
    ...
    var WebsiteComponent = /** @class */ (function () {
        function WebsiteComponent(pageService) {
            this.pageService = pageService;
         ...
         * @return {?}
         */
        WebsiteComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                if (this.pageService.stage == 'entry-next') {
         ...
         * @return {?}
         */
        WebsiteComponent.prototype.onSubmit = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        WebsiteComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
            };
         ...
         * @return {?}
         */
        WebsiteComponent.prototype.test = /**
         * @private
         * @param {?} url
         * @return {?}
         */
        ...
        /** @nocollapse */
        WebsiteComponent.ctorParameters = function () {
            return [
                { type: PagesService }
            ];
        };
        WebsiteComponent.propDecorators = {
            website: [{ type: i0.Input }],
            surveyResponse: [{ type: i0.Input }],
            submitEvent: [{ type: i0.Output }],
            isLastQuestion: [{ type: i0.Input }]
        };
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DefaultThankYouPageComponent = /** @class */ (function () {
        function DefaultThankYouPageComponent() {
        }
        /**
         * @return {?}
         */
        DefaultThankYouPageComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                //this.thankYouPage = PersistenceService.get(PagesComponent.CURRENT_PAGE);
         ...
         * @return {?}
         */
        DefaultThankYouPageComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DefaultThankYouPageComponent.ctorParameters = function () { return []; };
        return DefaultThankYouPageComponent;
    }());
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SurveyLibModule = /** @class */ (function () {
        function SurveyLibModule() {
        }
        SurveyLibModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            forms.FormsModule,
                            store.StoreModule.forRoot({ survey: surveyReducers })
                        ],
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var PagesModel = /** @class */ (function () {
        function PagesModel() {
        }
        Object.defineProperty(PagesModel.prototype, "testMode", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(PagesModel.prototype, "id", {
            get: /**
             * @return {?}
             */ function () {
                return this._id;
        ...
        Object.defineProperty(PagesModel.prototype, "userId", {
            get: /**
             * @return {?}
             */ function () {
                return this._userId;
        ...
        Object.defineProperty(PagesModel.prototype, "themeId", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(PagesModel.prototype, "logoUrl", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(PagesModel.prototype, "surveyContent", {
            get: /**
             * @return {?}
             */ function () {
    ...
    var SurveyContent = /** @class */ (function () {
        function SurveyContent() {
        }
        Object.defineProperty(SurveyContent.prototype, "name", {
            get: /**
             * @return {?}
             */ function () {
                return this._name;
        ...
        Object.defineProperty(SurveyContent.prototype, "description", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(SurveyContent.prototype, "pages", {
            get: /**
             * @return {?}
             */ function () {
                return this._pages;
    ...
    var SelectedThemeModel = /** @class */ (function () {
        function SelectedThemeModel() {
        }
    ...
    var Page = /** @class */ (function () {
        ...
        Object.defineProperty(Page.prototype, "properties", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(Page.prototype, "questions", {
            get: /**
             * @return {?}
             */ function () {
    ...
    var Others = /** @class */ (function () {
        function Others() {
        }
        return Others;
    }());
    var LogicJumps = /** @class */ (function () {
        function LogicJumps() {
        }
        return LogicJumps;
    }());
    ...
    var RankingItem = /** @class */ (function () {
    ...
    var Picture = /** @class */ (function () {
        ...
        Object.defineProperty(Picture.prototype, "picture", {
            get: /**
             * @return {?}
             */ function () {
    ...
    var AddressForm = /** @class */ (function () {
        ...
        Object.defineProperty(AddressForm.prototype, "text", {
            get: /**
             * @return {?}
             */ function () {
                return this._text;
        ...
        Object.defineProperty(AddressForm.prototype, "required", {
            get: /**
             * @return {?}
             */ function () {
    ...
    var Row = /** @class */ (function () {
        ...
        Object.defineProperty(Row.prototype, "text", {
            get: /**
             * @return {?}
             */ function () {
                return this._text;
    ...
    var Properties = /** @class */ (function () {
        ...
        Object.defineProperty(Properties.prototype, "buttonText", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(Properties.prototype, "subHeadingValue", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(Properties.prototype, "headingValue", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(Properties.prototype, "backgroundImage", {
            get: /**
             * @return {?}
             */ function () {
    ...
    exports.SurveyLibService = SurveyLibService;
    exports.CurrentElement = CurrentElement;
    exports.SurveyLibComponent = SurveyLibComponent;
    exports.SurveyLibModule = SurveyLibModule;
    exports.PagesModel = PagesModel;
    exports.SurveyContent = SurveyContent;
    exports.SelectedThemeModel = SelectedThemeModel;
    exports.Font = Font;
    exports.Colors = Colors;
    exports.Page = Page;
    exports.Question = Question;
    exports.Others = Others;
    exports.LogicJumps = LogicJumps;
    exports.Block = Block;
    ...
    exports.ɵw = DefaultThankYouPageComponent;
    exports.ɵb = PagesComponent;
    exports.ɵq = AddressComponent;
    exports.ɵt = AgreeDisagreeComponent;
    exports.ɵf = ChoiceComponent;
    exports.ɵp = ContactFormComponent;
    exports.ɵm = DateComponent;
    exports.ɵo = DropDownComponent;
    exports.ɵk = EmailComponent;
    exports.ɵi = LongTextComponent;
    exports.ɵs = NameComponent;
    exports.ɵl = NpsComponent;
    exports.ɵv = NumberComponent;
    exports.ɵr = PhoneComponent;
    exports.ɵd = QuestionnaireComponent;
    exports.ɵn = RatingComponent;
    exports.ɵh = ShortTextComponent;
    exports.ɵj = StatementComponent;
    exports.ɵu = WebsiteComponent;
    exports.ɵg = YesNoComponent;
    exports.ɵz = surveyReducers;
    exports.ɵe = ThankYouPageComponent;
    exports.ɵc = WelcomePageComponent;
    exports.ɵy = AutofocusDirective;
    exports.ɵa = PagesService;
    exports.ɵba = PersistenceService;
    exports.ɵx = ShufflePipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=survey-lib.umd.js.map